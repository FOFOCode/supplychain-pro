...
const options = {
  definition: {
    ...
    paths: {
      ...
      "/api/envios": {
        get: { tags: ["Envios"], summary: "Listar envios", security: [{ bearerAuth: [] }], responses: { "200": { description: "Lista envios" } } },
        post: { tags: ["Envios"], summary: "Crear envio (ADMIN)", security: [{ bearerAuth: [] }], requestBody: { required: true, content: { "application/json": { schema: { $ref: "#/components/schemas/Envio" } } } }, responses: { "201": { description: "Envio creado", content: { "application/json": { schema: { $ref: "#/components/schemas/Envio" } } } } } },
      },
      "/api/envios/{id}": {
        get: { tags: ["Envios"], summary: "Obtener envio por id", security: [{ bearerAuth: [] }], parameters: [{ name: "id", in: "path", required: true, schema: { type: "integer" } }], responses: { "200": { description: "Envio", content: { "application/json": { schema: { $ref: "#/components/schemas/Envio" } } } } } },
        put: { tags: ["Envios"], summary: "Actualizar envio (ADMIN)", security: [{ bearerAuth: [] }], parameters: [{ name: "id", in: "path", required: true, schema: { type: "integer" } }], requestBody: { required: true, content: { "application/json": { schema: { $ref: "#/components/schemas/Envio" } } } }, responses: { "200": { description: "Envio actualizado" } } },
        delete: { tags: ["Envios"], summary: "Eliminar envio (ADMIN)", security: [{ bearerAuth: [] }], parameters: [{ name: "id", in: "path", required: true, schema: { type: "integer" } }], responses: { "204": { description: "Eliminado" } } },
      },
